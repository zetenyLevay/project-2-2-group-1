// Batch-only entry point for CUDA builds — no GUI or OpenGL dependencies.
#include "main.h"
...
int main(int argc, char* argv[]) {
    ...
    std::cerr << "Unknown mode: " << mode << "\n"
              << "Usage: " << argv[0] << " --batch <width> <height> <temperature> <constantHeat> <NumberOfSims> <filename>\n";
    return 1;
}
